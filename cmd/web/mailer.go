...
// a function to listen to MailerChan
...
func (m *Mail) sendMail(msg Message, errorChan chan error) {
	...
	if msg.AttachementMap == nil {
		msg.AttachementMap = make(map[string]string)
	}
	...
	formatedMessage, err := m.buildHTMLMesssage(msg)
	if err != nil {
		errorChan <- err
	}
	...
	if len(msg.AttachementMap) > 0 {
		for key, value := range msg.AttachementMap {
...
func (m *Mail) buildHTMLMesssage(msg Message) (string, error) {
